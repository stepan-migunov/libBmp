...
int create(char* fileName, size_t size_x, size_t size_y);
...
///(border == 0)border is used when you want it be border with color,
///(border < 0)be border white with with white filling and colored border with thickness -border
///(border > 0)or be border with nothing but with colored border with thikness border
